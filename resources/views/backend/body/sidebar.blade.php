    ...
    <div class="sidebar-inner px-4 pt-3">
        <ul class="nav flex-column pt-3 pt-md-0">
            ...
            <li class="nav-item @if(request()->routeIs('categories.index')) active @endif">
                <a href="{{ route('categories.index') }}" class="nav-link d-flex justify-content-between">
                    <span>
                    <span class="sidebar-icon">
            ...
            <li class="nav-item @if(request()->routeIs('tags.index')) active @endif ">
                <a href="{{ route('tags.index') }}" class="nav-link">
                    ...
                    <span class="sidebar-text">Manage Tags</span>
                </a>
            </li>
            <li class="nav-item @if(request()->routeIs('articles.index')) active @endif">
                <a href="{{ route('articles.index') }}" class="nav-link d-flex justify-content-between">
                    <span>
                    <span class="sidebar-icon">
