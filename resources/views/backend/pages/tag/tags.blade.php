...
@section('title', 'StoryVilla - Manage Tags')
@section('content')
    <main class="content">
        ...
        <div class="py-4">
            ...
            <div class="d-flex justify-content-between w-100 flex-wrap">
                <div class="mb-3 mb-lg-0">
                    <h1 class="h4">Tags</h1>
                    <p class="mb-0">Add new, edit and delete tags</p>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-12 mb-4">
                <div class="card border-0 shadow components-section">
                    <div class="card-body">
                        <a href="{{ route('tags.create') }}" class="btn btn-gray-800 d-inline-flex align-items-center me-2 mb-4">
