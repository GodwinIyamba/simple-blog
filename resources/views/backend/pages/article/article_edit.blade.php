                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-lg-6 col-sm-6">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control" id="title" name="title" value="{{ $article->title }}" placeholder="Add a title...">
                                        @error('title')
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control" id="tags" name="tags" value="{{ $tagsOld }}" placeholder="Separate tags with commas">
                                        @error('tags')
                                            <span style="color: red;">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-lg-6 col-sm-6">
                                    <div class="mb-4">
                                        ...
                                        <textarea class="form-control" name="body" placeholder="Start writing your article..." id="textarea" rows="11">{{ $article->body }}</textarea>
                                    </div>
                                    @error('body')
                                    <span style="color: red;">{{ $message }}</span>
                                    @enderror
