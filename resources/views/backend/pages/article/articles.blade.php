...
@section('title', 'StoryVilla - Manage Articles')
@section('content')
    <main class="content">
        ...
        <div class="py-4">
            ...
            <div class="d-flex justify-content-between w-100 flex-wrap">
                <div class="mb-3 mb-lg-0">
                    ...
                    <p class="mb-0">Add new, edit and delete articles</p>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-12 mb-4">
                <div class="card border-0 shadow components-section">
                    <div class="card-body">
                        <a href="{{ route('articles.create') }}" class="btn btn-gray-800 d-inline-flex align-items-center me-2 mb-4">
                        ...
                        <div class="table-responsive">
                            <table class="table table-centered table-nowrap mb-0 rounded">
                                ...
                                <tr>
                                    ...
                                    <th class="border-0 col-6">body</th>
                                    <th class="border-0 col-1">Category</th>
                                    <th class="border-0 col-1">Tags</th>
                                    <th class="border-0 rounded-end col-1">Action</th>
                                </tr>
                                </thead>
                                <tbody>
                                <!-- Item -->
